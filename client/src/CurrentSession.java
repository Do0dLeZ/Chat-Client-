...
public class CurrentSession {
    private static final String FILE_PATH = "D:\\Programming\\SpringLessons\\MyChatClient\\client\\src\\session.json";
    ...
    /**
     * Если пустой файл "(Your source path) ... \ChatClient\client\src\authorization\session.json"
    ...
    /**
     * Проверяем файл "(Your source path) ... \ChatClient\client\src\authorization\session.json"
    ...
    /**
     * Если в файле "(Your source path) ... \ChatClient\client\src\authorization\session.json"
